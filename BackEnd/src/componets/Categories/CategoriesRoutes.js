...
const {
  getAllCategories, getAllCategoriesWithPagination, createCategory, updateCategory, deleteCategory, getAllUserCategories,
...
router.get('/all-user-categories', getAllUserCategories);
