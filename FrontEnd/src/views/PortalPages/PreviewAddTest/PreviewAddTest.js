import TestControls from 'components/PreviewAddTest/TestControls/TestControls'
import TestPagination from 'components/PreviewAddTest/TestPagination/TestPagination'
import React, { useEffect, useState } from 'react'
import { Container } from 'react-bootstrap'
import TestQuestionsForm from 'components/PreviewAddTest/TestQuestionsForm/TestQuestionsForm'
import { useForm ,FormProvider } from 'react-hook-form'
import Cookies from 'js-cookie'

function PreviewAddTest() {
  // let answerModal={
  //   id:dat.id,
  ...
  // }
    ...
    const [fireChangeQuestion,setFireChangeQuestion] =useState(0)
    ...
    let exams = JSON.parse(localStorage.getItem('previewExamData')) ? JSON.parse(localStorage.getItem('previewExamData')) :[]
    ...
    useEffect(() => {
        exams = JSON.parse(localStorage.getItem('addedExamData'))
        setTestData(exams)
        createQuestionStatesArray(exams)
    },[fireChangeQuestion])
    window.addEventListener('storage', () => {
        setFireChangeQuestion(prevVal=>prevVal+1)
    })
  return (
