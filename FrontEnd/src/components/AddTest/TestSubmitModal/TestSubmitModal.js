        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}  size="lg" centered>
                ...
                <div className={`${styles["modal-body"]} modal-body`}>
                    <h5 className={`${styles["modal-title__main"]} modal-title`}>Add Questions</h5>
                    <h6 className={`${styles["modal-title__second"]} modal-title`}> Are You Sure You Want To Add The Questions ?</h6>
                    <div className={styles['submit-modal__buttons-cont']}>
                        ...
                        <button type="button" className={styles['submit-modal__confirm-button']} onClick={endExam}>Yes , Add The Questions</button>
